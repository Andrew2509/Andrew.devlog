            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div class="group bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] transition-all duration-700 hover:-translate-y-4">
                    <div class="relative overflow-hidden aspect-[4/3]">
                        ...
                        <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2426&auto=format&fit=crop" alt="Corporate Pro" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        <div class="absolute inset-x-0 bottom-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-500 z-20">
                            <a href="#" class="w-full bg-white text-gray-900 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 shadow-xl hover:bg-primary hover:text-white transition-all">
                                <i class="fas fa-eye text-sm"></i> Live Preview
                            </a>
                        </div>
                        <div class="absolute top-6 left-6 z-20">
                            <span class="bg-white/90 backdrop-blur-md text-gray-900 text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-widest shadow-sm">Popular</span>
                        </div>
                    </div>
                    <div class="p-10">
                        <div class="flex items-center gap-2 mb-4">
                            <span class="text-primary/60 text-[10px] font-black uppercase tracking-widest">Company Profile</span>
                        </div>
                        <h3 class="text-2xl font-black text-gray-900 mb-3 tracking-tight">Corporate <span class="text-primary italic">Pro Max</span></h3>
                        <p class="text-gray-500 text-sm leading-relaxed mb-8">Desain elegan dan profesional untuk meningkatkan kredibilitas perusahaan Anda dengan tata letak yang bersih.</p>
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-50">
                            ...
                            <span class="text-primary font-black text-lg">Rp 1.499k</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] transition-all duration-700 hover:-translate-y-4">
                    <div class="relative overflow-hidden aspect-[4/3]">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                        <img src="https://images.unsplash.com/photo-1557821552-17105176677c?q=80&w=2689&auto=format&fit=crop" alt="E-Shop Ultra" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        <div class="absolute inset-x-0 bottom-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-500 z-20">
                            <a href="#" class="w-full bg-white text-gray-900 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 shadow-xl hover:bg-primary hover:text-white transition-all">
                                <i class="fas fa-eye text-sm"></i> Live Preview
                            </a>
                        ...
                        <div class="absolute top-6 left-6 z-20">
                             <span class="bg-primary text-white text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-widest shadow-lg shadow-primary/20 animate-bounce">Flash Sale</span>
                        </div>
                    </div>
                    <div class="p-10">
                        <div class="flex items-center gap-2 mb-4">
                            <span class="text-primary/60 text-[10px] font-black uppercase tracking-widest">E-Commerce</span>
                        </div>
                        <h3 class="text-2xl font-black text-gray-900 mb-3 tracking-tight">E-Shop <span class="text-primary italic">Ultra X</span></h3>
                        <p class="text-gray-500 text-sm leading-relaxed mb-8">Solusi toko online lengkap dengan manajemen produk, keranjang belanja, dan integrasi pembayaran.</p>
                        
                        <div class="flex items-center justify-between pt-6 border-t border-gray-50">
                            <div class="flex items-center gap-3">
                                <div class="flex -space-x-2">
                                    <div class="w-6 h-6 rounded-full border-2 border-white bg-orange-500 flex items-center justify-center text-[10px] text-white font-bold"><i class="fab fa-html5"></i></div>
                                    <div class="w-6 h-6 rounded-full border-2 border-white bg-blue-400 flex items-center justify-center text-[10px] text-white font-bold"><i class="fab fa-css3-alt"></i></div>
                                    <div class="w-6 h-6 rounded-full border-2 border-white bg-yellow-400 flex items-center justify-center text-[10px] text-white font-bold"><i class="fab fa-js"></i></div>
                                </div>
                                <span class="text-[10px] text-gray-400 font-bold">Tech Stack</span>
                            </div>
                            <span class="text-primary font-black text-lg">Rp 2.999k</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] transition-all duration-700 hover:-translate-y-4">
                    <div class="relative overflow-hidden aspect-[4/3]">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                        <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=2670&auto=format&fit=crop" alt="Creative Portfolio" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        <div class="absolute inset-x-0 bottom-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-500 z-20">
                            <a href="#" class="w-full bg-white text-gray-900 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 shadow-xl hover:bg-primary hover:text-white transition-all">
                                <i class="fas fa-eye text-sm"></i> Live Preview
                            </a>
                        ...
                        <div class="absolute top-6 left-6 z-20">
                            <span class="bg-gray-900 text-white text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-widest shadow-sm">Minimalist</span>
                        </div>
                    </div>
                    <div class="p-10">
                        <div class="flex items-center gap-2 mb-4">
                            <span class="text-primary/60 text-[10px] font-black uppercase tracking-widest">Portfolio</span>
                        </div>
                        <h3 class="text-2xl font-black text-gray-900 mb-3 tracking-tight">Creative <span class="text-primary italic">Portfolio</span></h3>
                        <p class="text-gray-500 text-sm leading-relaxed mb-8">Pamerkan karya terbaik Anda dengan tampilan visual yang menakjubkan dan interaksi yang halus.</p>
                        
                        <div class="flex items-center justify-between pt-6 border-t border-gray-50">
                            <div class="flex items-center gap-3">
                                <div class="flex -space-x-2">
                                    <div class="w-6 h-6 rounded-full border-2 border-white bg-pink-500 flex items-center justify-center text-[10px] text-white font-bold"><i class="fab fa-vuejs"></i></div>
                                    <div class="w-6 h-6 rounded-full border-2 border-white bg-green-500 flex items-center justify-center text-[10px] text-white font-bold"><i class="fab fa-node-js"></i></div>
                                </div>
                                <span class="text-[10px] text-gray-400 font-bold">Tech Stack</span>
                            </div>
                            <span class="text-primary font-black text-lg">Rp 999k</span>
                        </div>
                    </div>
                </div>
