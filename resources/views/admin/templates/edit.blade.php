            ...
            <div class="bg-white/[0.03] border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $template->name) }}" placeholder="Contoh: Banner Promo Lebaran" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <!-- Legacy fallback for 'type' column -->
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6">
                            <div class="flex items-start gap-4">
                                <div class="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center text-blue-400 shrink-0 shadow-lg shadow-blue-500/10">
                                    <i class="fas fa-rocket"></i>
                                </div>
                                <div class="flex-1">
                                    <h5 class="text-blue-400 font-bold mb-1">Optimal Preview</h5>
                                    <p class="text-gray-400 text-xs leading-relaxed">
                                        Input link landing page atau link demo langsung. Sistem akan secara otomatis mengoptimalkan link untuk pratinjau terbaik di website Anda.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-2 px-1">
                            ...
                            <label for="is_new_tab" class="text-sm text-gray-400 cursor-pointer">Buka di tab baru (Rekomendasi)</label>
                        </div>
                    </div>
