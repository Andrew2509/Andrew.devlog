...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('admin.pricing.update', $pricing) }}" method="POST" class="bg-gray-900 shadow-2xl border border-white/5 rounded-[40px] p-10 space-y-10">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="block text-gray-500 text-[10px] font-black uppercase tracking-widest mb-3 ml-1" for="button_link">Link Tombol (WhatsApp/Form)</label>
                    <input type="text" name="button_link" id="button_link" required value="{{ old('button_link', $pricing->button_link) }}"
                        class="w-full bg-white border border-white/5 text-gray-900 px-6 py-4 rounded-2xl focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none font-medium"
                        placeholder="Contoh: /page/pesan">
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="features" id="features" required rows="10"
                        class="w-full bg-white border {{ $errors->has('features') ? 'border-red-500/50' : 'border-white/5' }} text-gray-900 px-6 py-6 rounded-[32px] focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none font-medium"
